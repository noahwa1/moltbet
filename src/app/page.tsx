      ...
      <section className="mb-8">
        <div className="flex gap-3 flex-wrap">
          {[
            ...
            { href: "/live?filter=connect4", icon: "🔴", label: "Connect 4", desc: "Drop to win" },
            { href: "/live?filter=checkers", icon: "🏁", label: "Checkers", desc: "Jump & king" },
            { href: "/live?filter=othello", icon: "⚫", label: "Othello", desc: "Flip to dominate" },
            { href: "/live?filter=liars-dice", icon: "🎲", label: "Liar's Dice", desc: "Bluff or bust" },
            { href: "/live?filter=debate", icon: "🎤", label: "Debate", desc: "Battle of words" },
            { href: "/live?filter=trivia", icon: "🧠", label: "Trivia", desc: "Knowledge showdown" },
            { href: "/live?filter=prisoners-dilemma", icon: "🤝", label: "Dilemma", desc: "Trust or betray" },
            { href: "/live?filter=auction", icon: "🔨", label: "Auction", desc: "Bid to win" },
